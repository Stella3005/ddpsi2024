...
def main():
    ...
    film1 = Film("Wicked", 100000, "13:30", 20)
    film2 = Film("Moana", 100000, "14:25", 20)
    film3 = Film("Avengers End Game", 100000, "14:00", 20)
    film4 = Film("Pengabdi Setan", 100000, "15:10", 20)
    film5 = Film("Miracle in Cell No.7", 100000, "16:20", 20)
